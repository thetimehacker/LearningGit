...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=4136193759ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=database&table=signup">`database`.`signup`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=database&table=activity">`database`.`activity`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=database&table=student">`database`.`student`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=database&table=club">`database`.`club`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project_data&table=Signup_form_data">`project_data`.`Signup_form_data`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project_data&table=student_coordinator">`project_data`.`student_coordinator`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=information_schema&table=ALL_PLUGINS">`information_schema`.`ALL_PLUGINS`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=phpmyadmin&table=pma__central_columns">`phpmyadmin`.`pma__central_columns`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=phpmyadmin&table=pma__bookmark">`phpmyadmin`.`pma__bookmark`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `activity` WHERE aname=&quot;shubham&quot;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="database" targettable="student">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `activity` (`sid`, `aid`, `aname`, `date`, `description`, `flag`) VALUES (&#039;1&#039;, NULL, &#039;shubham&#039;, &#039;2022-04-02&#039;, &#039;this is the first activity i am going to create&#039;, &#039;0&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="database" targettable="signup">
                            <div class="action_content">
