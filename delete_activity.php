...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="add_activity.php"> Add</a></li>
      <li class="active"><a href="delete_activity.php">Remove</a></li>
    </ul>
		...
		<div class="col-sm-12">
			...
			<div class="col-sm-4">
					<div class="admin_heading">
						<h1 style="text-align: center;">Delete Activities</h1>
					</div>
			
					<div class="admin_tick" style="text-align: left;margin-bottom: 20px;">
						<!-- //create php  -->
						<h4 style="text-align: center;">Delete Activities</h4>
						<?php
							session_start();
							
							include('connection.php');
							$check=$db->prepare('SELECT * FROM activity');
							$check->execute();
							if($check->rowcount()==0){
						...
						<form id="adminform" action="adminhome.php" method="post">
							<div class="form-group">
								<label><?php echo $datarow['aname']; ?></label>
